...
public enum RealLifeCoin {
    ...
    // learnt from these few lines of code is, anything not integer, use BigDecimal. And decimal parameter parse in
    // constructor must be strings, if you create a BigDecimal by double, it will lose accuracy instantly. For example
    // new BigDecimal(0.5) will mess things up and new BigDecimal("0.5") will work.
